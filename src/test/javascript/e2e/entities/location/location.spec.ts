...
describe('Location e2e test', () => {
  ...
  it('should load Locations', async () => {
    ...
    expect(await locationComponentsPage.getTitle()).to.eq('studelyApp.location.home.title');
  });
  ...
  it('should load create Location page', async () => {
    ...
    expect(await locationUpdatePage.getPageTitle()).to.eq('studelyApp.location.home.createOrEditLabel');
  ...
  it('should delete last Location', async () => {
    ...
    expect(await locationDeleteDialog.getDialogTitle()).to.eq('studelyApp.location.delete.question');
